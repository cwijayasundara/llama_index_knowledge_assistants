...
from sql_db_setup import sql_query_engine
...
index = LlamaCloudIndex(
  ...
  organization_id="c10b2ad3-a6c4-4a54-be2a-143a5400bf5f",
  api_key=api_key
)
...
async def main():
    result_1 = await wf.run(message="List all of the places to visit in New York?")
    result_2 = await wf.run(message="What is the population of New York?")
